...
public class VgerSamplingActuator implements Serializable {
	 ...
	 */
	// public VgerSamplingActuator(JSONObject sampling_actuator_obj) {
	...
	// this.actuator = new VgerActuator(actuator);
	// }
	 ...
	 * @param timestamp
	 */
	// public VgerSamplingActuator(String actuator_uuid, boolean command_value,
	...
	// VgerActuator vger_actuator = new
	// VgerActuator(actuator_json_obj.getJSONObject("data"));
	// this.actuator = vger_actuator;
	// }

	public VgerSamplingActuator(GlobalProperties globalProperties) {
	...
	public VgerActuator getActuator() {
		return actuator;
	}

	public void setActuator(VgerActuator actuator) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VgerSamplingActuator other = (VgerSamplingActuator) obj;
